...
import FiltersAndSorts from '../client/src/components/FiltersAndSorts';
import Adapter from 'enzyme-adapter-react-16';

Enzyme.configure({ adapter: new Adapter() });

describe('FiltersAndSorts component', () => {
  test('renders', () => {
    const FiltersAndSortsProps = {
      reviews: 
      [
        {
    ...
    const wrapper = shallow(<FiltersAndSorts {...FiltersAndSortsProps}/>);
